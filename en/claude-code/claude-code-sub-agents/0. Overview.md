...
- [[3-Research/Claude Code/claude-code-sub-agents/1. Architecture and Logic]] — Internal architecture, data flow, configuration
- [[3-Research/Claude Code/claude-code-sub-agents/2. Playbook]] — Setup, creating agents, cheat sheet, troubleshooting
