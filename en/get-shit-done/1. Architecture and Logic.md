...
> [!NOTE]
> This document goes deep into **internal operational mechanisms** of GSD. Read [0. Overview](./0. Overview.md) first for the big picture.
...
- [0. Overview](./0. Overview.md) — GSD system overview
- [2. Playbook](./2. Playbook.md) — Practical operations playbook
