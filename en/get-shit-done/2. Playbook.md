...
> [!NOTE]
> This is an **action-oriented** document. Read [0. Overview](./0. Overview.md) to understand what GSD is, [1. Architecture and Logic](./1. Architecture and Logic.md) to understand internal mechanisms.
