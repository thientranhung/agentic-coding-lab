...
> [!NOTE]
> Read this document BEFORE deciding to adopt GSD. Read [0. Overview](./0. Overview.md) if you don't know what GSD is yet.
...
| **Learning curve** | Need to understand 4-step workflow + slash commands | Read [2. Playbook](./2. Playbook.md) before starting |
