...
- [[3-Research/Claude Code/claude-code-sub-agents/1. Architecture and Logic]] — Data flow chi tiết, cấu hình nâng cao, hooks system
- [[3-Research/Claude Code/claude-code-sub-agents/2. Playbook]] — Hướng dẫn cài đặt, Day 1 workflow, cheat sheet, troubleshooting
