...
- [0. Overview](./0. Overview.md) — Tổng quan về Sub-agents, vấn đề giải quyết, tính năng nổi bật
- [1. Architecture and Logic](./1. Architecture and Logic.md) — Kiến trúc chi tiết, data flow, hooks system, memory system
